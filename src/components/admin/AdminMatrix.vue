      ...
      <table class="w-full text-xs border-separate border-spacing-0">
        ...
        <tbody class="divide-y divide-gray-100">
          <tr v-if="rows.length === 0">
            <td :colspan="COMORBIDITIES.length + 1" class="px-4 py-20 text-center">
              <div class="flex flex-col items-center justify-center text-gray-400">
                <svg class="w-12 h-12 mb-3 opacity-20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <p class="text-sm font-medium">No hay datos disponibles para la matriz</p>
                <p class="text-xs opacity-70 mt-1">Asegúrate de que existan epicrisis cargadas en el sistema.</p>
              </div>
            </td>
          </tr>
